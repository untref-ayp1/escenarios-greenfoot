...
public abstract class LienzoBase extends World {
     ...
     */
    private static final int TAMAÑO_DE_CELDA_POR_DEFECTO = 50;
    ...
    /**
     * Permite mostrar la coordenada de cada celda, para ayudar a pensar los algoritmos de pintado
     */
    public void mostrarAyudas() {
        ...
        for (int i = 0; i < getHeight(); i++) {
            for (int j = 0; j < getWidth(); j++) {
                ...
                // Greenfoot usa x, y como coordenada, que para nosotros son j y i (en ese orden)
